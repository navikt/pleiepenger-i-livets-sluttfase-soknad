...
export const velkommenPageMessages: MessageFileFormat = {
    nb: {
        ...
        'personopplysninger.4.1': 'opplysninger om helsen til den du skal pleie',
        ...
        'personopplysninger.6.1':
            'Du har rett til innsyn i saken din. Vil du vite mer om hvordan NAV behandler personopplysninger? Se ',
        'personopplysninger.6.2': 'nav.no/personvern',
        'personopplysninger.6.3': '.',

        'step.velkommen.button.start': 'Start søknad',
    },
};
